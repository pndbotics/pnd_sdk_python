...
KP_CONFIG = [
    ...
    405.0, 405.0, 205.0,                       # Waist: waistYaw, waistRoll, waistPitch   
    ...
    9.0,   # wristPitch_Right (27)
    9.0,   # wristYaw_Right (28)
]
...
KD_CONFIG = [
    ...
    0.9,   # elbow_Right
    0.9,   # wristRoll_Right 
    0.9,   # wristPitch_Right
    0.9,   # wristYaw_Right 
]


open_arm_pos = np.array([
...
if __name__ == '__main__':
    ...
    pub.Init()
    cmd = pnd_adam_msg_dds__LowCmd_(ADAM_SP_NUM_MOTOR)
